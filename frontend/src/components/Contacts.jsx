        ...
        <div className="jumbotron" style={{backgroundColor: "white", padding: "10px"}}>
            <h1 className="display-4">Всем привет</h1>
                ...
                <p>
                    ...
                    у меня есть свободное время, ведь материал, который мы проходим на курсах действительно интеретный.<br/>Внимание<br/>Спасибо за внимание<br/>&#129505;
                </p>
                <br/><h4>PS</h4>
                <p>
                    Что касается сайта, я понимаю, что недоработок много. Лайки сейчас это просто случайные числа и они никак не связаны с сервером, а еще выглядят стремно, я их добавил просто как декорацию). Комментарии тоже можно реализовать, хотя мне они кажутся не совсем уместными здесь. Также нельзя удалять посты. Еще, т.к. стили я применял из бутстрапа, мелкие доработки стилей я вставлял напрямую в jsx теги, хоть я и знаю, что это не хорошо, но содержимого там мало и решил пока оставить так, хотя надо было бы хотя бы вынести их в отдельный объект. Еще я не стал добавлять redux там, где стэйты используются только на собственной странице, пока только данные пользователя используются в большом количестве компонентов<br/>Я знаю как все это нужно сделать, но, к сожалению у меня не хватает времени, но после сессии я планирую для себя доделать сайт до приемлемго уровня.
                </p>
        </div>
    )
}
